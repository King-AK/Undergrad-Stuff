...
/* ============== */
{
  ...
  printf("   average jobs in server (l) .. = %6.2f\n", (sum.wait / index) * throughput);
  printf("   average jobs in queue (q) ... = %6.2f\n", (sum.delay / index) * throughput);
  printf("   average jobs in service (x) . = %6.2f\n", (sum.service / index) * throughput);
