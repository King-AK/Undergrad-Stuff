...
//follwing constants established using information from example 1.3.5
#define COST_ITEM 8000
#define COST_SETUP 1000
#define COST_HOLD 25
#define COST_SHORT 700
...
/* ============== */
{
  ...
  //for Exercise 1.3.2 - compute all four components of total average cost per week
  printf("   item cost per week ....... = %6.2f\n", (sum.order / index) * COST_ITEM);
  printf("   setup cost per week ...... = %6.2f\n", (sum.setup / index) * COST_SETUP);
  printf("   holding cost per week .... = %6.2f\n", (sum.holding / index) * COST_HOLD);
  printf("   shortage cost per week ... = %6.2f\n", (sum.shortage / index) * COST_SHORT);
